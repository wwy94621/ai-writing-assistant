...
exports.getRectangleFromTarget = exports.calculateGapSpace = exports.getBoundsFromTargetWindow = exports.getOppositeEdge = exports.getMaxHeight = exports.positionCard = exports.positionCallout = exports.positionElement = exports.__positioningTestPackage = void 0;
...
function _canScrollResizeToFitEdge(target, bounding, targetEdge, minimumScrollResizeHeight) {
    ...
    if (targetEdge !== positioning_types_1.RectangleEdge.bottom && targetEdge !== positioning_types_1.RectangleEdge.top) {
        return false;
    }
...
function _flipToFit(rect, target, bounding, positionData, shouldScroll, minimumScrollResizeHeight, gap) {
    ...
    for (var i = 0; i < 4; i++) {
        if (_isEdgeInBounds(currentEstimate, bounding, currentEdge)) {
            ...
            switch (currentEdge) {
                case positioning_types_1.RectangleEdge.bottom:
                    currentEstimate.bottom = bounding.bottom;
                    break;
                case positioning_types_1.RectangleEdge.top:
...
function _positionElement(props, hostElement, elementToPosition, previousPositions, win) {
    var theWin = win !== null && win !== void 0 ? win : (0, Utilities_1.getWindow)();
    var boundingRect = props.bounds
        ? _getRectangleFromIRect(props.bounds)
        : new Utilities_2.Rectangle(0, theWin.innerWidth - (0, Utilities_1.getScrollbarWidth)(), 0, theWin.innerHeight);
...
exports.calculateGapSpace = calculateGapSpace;
function getRectangleFromTarget(target) {
    return _getRectangleFromTarget(target);
}
exports.getRectangleFromTarget = getRectangleFromTarget;
